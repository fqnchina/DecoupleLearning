...
name = 'train_6_filter_operator_model'
...
with open('/mnt/codes/imageOperator_codes/train_6_filter_operator_model.py', 'r') as fin:
    print(fin.read())
print("***********************************************")
...
for p in range(epoches):
    train_loss_all = [0,0,0,0,0,0]
    test_loss_all = [0,0,0,0,0,0]
    train_count_all = [0.001,0.001,0.001,0.001,0.001,0.001]
    test_count_all = [0.001,0.001,0.001,0.001,0.001,0.001]
    train_loss = 0
    test_loss = 0
    train_count = 0
    test_count = 0
    ...
    print('Epoch: %d train loss: L0smooth: %.4f, WLS: %.4f, RTV: %.4f, RGF: %.4f, WMF: %.4f, shock: %.4f'%(p+1,train_loss_all[0]/train_count_all[0],train_loss_all[1]/train_count_all[1],train_loss_all[2]/train_count_all[2],train_loss_all[3]/train_count_all[3],train_loss_all[4]/train_count_all[4],train_loss_all[5]/train_count_all[5]))
    print('Epoch: %d train loss: L0smooth: %.4f, WLS: %.4f, RTV: %.4f, RGF: %.4f, WMF: %.4f, shock: %.4f'%(p+1,test_loss_all[0]/test_count_all[0],test_loss_all[1]/test_count_all[1],test_loss_all[2]/test_count_all[2],test_loss_all[3]/test_count_all[3],test_loss_all[4]/test_count_all[4],test_loss_all[5]/test_count_all[5]))
