...
with open('/mnt/codes/imageOperator_codes/train_10_operator_model.py', 'r') as fin:
    print(fin.read())
print("***********************************************")
